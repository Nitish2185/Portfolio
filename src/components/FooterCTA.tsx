          ...
          <div className="w-full">
            ...
            <div className="hidden sm:grid grid-cols-2 gap-px bg-white/10 rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.4)] overflow-hidden border border-white/10">
              <div className="relative group/email">
                <a href="mailto:nns.nitish2185@gmail.com"
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-white text-lg md:text-xl font-medium tracking-tight">nns.nitish2185@gmail.com</span>
                  </div>
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText('nns.nitish2185@gmail.com');
              ...
              <a href="https://github.com/nitish2185" target="_blank" rel="me noreferrer"
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-white text-lg md:text-xl font-medium tracking-tight">github.com/nitish2185</span>
                </div>
              ...
              <a href="https://linkedin.com/in/Nitish2185" target="_blank" rel="me noreferrer"
                className="bg-[#0A0D14]/80 hover:bg-[#111621]/90 transition-all duration-700 p-8 md:p-12 flex flex-col items-start gap-4 group">
                <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center relative group-hover:border-[#1D91A1]/40 group-hover:bg-[#1D91A1]/10 transition-all duration-500 overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#1D91A1]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-white text-lg md:text-xl font-medium tracking-tight">linkedin.com/in/Nitish2185</span>
                </div>
              ...
              <a href="https://x.com/Nitish2185" target="_blank" rel="noreferrer"
                className="bg-[#0A0D14]/80 hover:bg-[#111621]/90 transition-all duration-700 p-8 md:p-12 flex flex-col items-start gap-4 group">
                <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center relative group-hover:border-[#1D91A1]/40 group-hover:bg-[#1D91A1]/10 transition-all duration-500 overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#1D91A1]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-white text-lg md:text-xl font-medium tracking-tight">@Nitish2185</span>
                </div>
            ...
            <div className="flex flex-col items-center sm:hidden w-full gap-10 mt-4 px-4 text-center">
              ...
              <div className="flex flex-col items-start w-full gap-5 pl-10">
                <a href="mailto:nns.nitish2185@gmail.com" className="font-mono text-[18px] tracking-[0.15em] text-white hover:text-[#1D91A1] transition-colors flex items-center gap-3">
                  EMAIL <span className="text-[14px] opacity-40">↗</span>
                </a>
                <a href="https://github.com/nitish2185" target="_blank" rel="me noreferrer" className="font-mono text-[18px] tracking-[0.15em] text-white hover:text-[#1D91A1] transition-colors flex items-center gap-3">
                  GITHUB <span className="text-[14px] opacity-40">↗</span>
                </a>
                <a href="https://linkedin.com/in/Nitish2185" target="_blank" rel="me noreferrer" className="font-mono text-[18px] tracking-[0.15em] text-white hover:text-[#1D91A1] transition-colors flex items-center gap-3">
                  LINKEDIN <span className="text-[14px] opacity-40">↗</span>
                </a>
                <a href="https://x.com/Nitish2185" target="_blank" rel="noreferrer" className="font-mono text-[18px] tracking-[0.15em] text-white hover:text-[#1D91A1] transition-colors flex items-center gap-3">
